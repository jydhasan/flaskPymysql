...
app = Flask(__name__)
# Update the MySQL connection string based on your XAMPP MySQL configuration
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://jydhasan:124055@localhost/jydhasan'
db = SQLAlchemy(app)
